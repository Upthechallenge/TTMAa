 ...
 */
public class ListEventBynameActivity extends ListActivity {
    ...
    class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ListAdapter adapter = new SimpleAdapter(ListEventBynameActivity.this, contactList,R.layout.list_item, new String[] { TAG_NAME, }, new int[] { R.id.name});
