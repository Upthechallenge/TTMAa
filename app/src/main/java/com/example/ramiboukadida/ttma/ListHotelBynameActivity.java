...
/**
 * Created by MEHDI on 11/11/2015.
 */
public class ListHotelBynameActivity extends ListActivity {


    String url = "http://10.0.2.2:18080/PidevService-web/rest/events/lister/";
    private String data = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url="http://10.0.2.2:18080/PidevService-web/rest/events/lister/"+value;
    ...
    class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ListAdapter adapter = new SimpleAdapter(ListHotelBynameActivity.this, contactList,R.layout.list_item, new String[] { TAG_NAME, }, new int[] { R.id.name});
