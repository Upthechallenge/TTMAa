 ...
 */
public class ListProblemActivity extends ListActivity {
    private static String url = "http://10.0.2.2:18080/PidevService-web/rest/problems/list";
    private String data = "";
    ...
    class GetContacts extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            try {
                ...
                for(int i=0; i < jsonArray.length(); i++){
                    ...
                    contact.put(TAG_NAME,"title: "+ name);
        ...
        protected void onPostExecute(Void result) {
            ListAdapter adapter = new SimpleAdapter(ListProblemActivity.this, contactList,R.layout.list_item, new String[] { TAG_NAME, }, new int[] { R.id.name});
